...
<div class="container">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="coiffeuse-card">
                ...
                <div class="coiffeuse-body">
                    ...
                    <div class="coiffeuse-spec"><?= htmlspecialchars($c['specialite']) ?></div>
                    ...
                    <div class="coiffeuse-tags">
                        ...
                        <span class="coiffeuse-tag"><?= htmlspecialchars(trim($t)) ?></span>
                        <?php endforeach; ?>
                    </div>
                    <?php endif; ?>

                    <?php if(!empty($c['annees_experience'])): ?>
                    <div class="coiffeuse-exp">
                        <strong><?= htmlspecialchars($c['annees_experience']) ?> ans</strong>
    ...
    <div class="cta-section">
        <h2 style="font-family:'Playfair Display',serif;color:#fff;font-size:1.8rem;font-weight:900;margin-bottom:10px">
            Prete a vous faire chouchouter ?
        </h2>
