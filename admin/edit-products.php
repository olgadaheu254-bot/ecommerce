...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(empty($name) || empty($price) || empty($sku)) {
        ...
        if($stmt->fetch()) {
            $error = "Ce SKU existe déjà pour un autre produit.";
        } else {
            try {
                ...
                if($stmt->execute([$category_id, $name, $slug, $description, $price, $stock, $image_url, $sku, $active, $featured, $product_id])) {
    ...
    <div class="row">
        ...
        <main class="col-md-10 ms-sm-auto px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2"><i class="bi bi-pencil-square"></i> Modifier le Produit</h1>
                <div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="active" 
                                                   name="active" <?php echo $product['active'] ? 'checked' : ''; ?>>
                                        ...
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" id="featured" 
                                                   name="featured" <?php echo $product['featured'] ? 'checked' : ''; ?>>
                                        ...
                                        <p class="text-muted small">
                                            ...
                                            <?php echo date('d/m/Y à H:i', strtotime($product['created_at'])); ?>
                                        </p>
