...
<div class="dash-card">
    ...
    <div style="text-align:center;padding:40px;color:#9a7c5c">
        <h5 style="color:#3E1F0D">Aucun client trouve</h5>
    </div>
    <?php endif; ?>
    </div>
</div>
...
<div class="detail-overlay" onclick="if(event.target===this)window.location='users.php'">
    <div class="detail-modal">
        <div class="detail-modal-header">
            ...
            <a href="users.php" class="close-btn">x</a>
        </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-6">
                    <div style="background:#fff;border:1px solid #F5E6D3;border-radius:12px;padding:14px;text-align:center">
                        ...
                        <div style="font-size:0.72rem;color:#9a7c5c">Depenses totales</div>
                    </div>
                </div>
            </div>

            <?php if(count($user_orders) > 0): ?>
            <h6 style="color:#3E1F0D;font-weight:700;margin-bottom:12px">Dernieres commandes</h6>
            <?php
